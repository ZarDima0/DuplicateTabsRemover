...
View all duplicate tabs grouped by URL
Close individual duplicates - Click the × button next to any tab
Close all duplicates - Click "Close All Duplicates" button to remove all at once
...
Queries all open tabs using Chrome's Tabs API
Groups tabs by their URL
Identifies URLs with multiple instances as duplicates
Displays duplicates in an organized list
Allows selective or bulk removal while preserving one tab per URL
